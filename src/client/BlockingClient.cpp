...
void BlockingClient::requestNewFortune()
{
  ...
  ClientWorker *worker = new ClientWorker(hostLineEdit->text(), portLineEdit->text().toUInt());

  worker->moveToThread(workerThread);

  connect(workerThread, &QThread::started, worker, &ClientWorker::process);
  ...
  connect(worker, &ClientWorker::finished, workerThread, &QThread::quit);
